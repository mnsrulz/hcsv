...
RUN sqlite-utils insert /data/data.db FY2021_Q3 /FY2021_Q3.csv --csv
...
RUN sqlite-utils insert /data/data.db FY2021_Q4 /FY2021_Q4.csv --csv
...
RUN sqlite-utils insert /data/data.db FY2022_Q1 /FY2022_Q1.csv --csv
...
RUN sqlite-utils insert /data/data.db FY2022_Q2 /FY2022_Q2.csv --csv
...
RUN sqlite-utils insert /data/data.db FY2022_Q3 /FY2022_Q3.csv --csv
...
RUN sqlite-utils insert /data/data.db FY2022_Q4 /FY2022_Q4.csv --csv
...
RUN sqlite-utils insert /data/data.db FY2023_Q1 /FY2023_Q1.csv --csv
...
ENTRYPOINT ["datasette", "/app/data.db", "-h", "0.0.0.0", "--setting","sql_time_limit_ms","30000"]